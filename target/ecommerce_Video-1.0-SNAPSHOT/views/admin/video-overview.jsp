...
<head>
    ...
    <title>AdminLTE 3 | Overview</title>
    ...
    <link rel="stylesheet"
          href="${pageContext.servletContext.contextPath}/views/template/admin/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet"
          href="${pageContext.servletContext.contextPath}/views/template/admin/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet"
          href="${pageContext.servletContext.contextPath}/views/template/admin/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    <!-- Theme style -->
    <link rel="stylesheet"
          href="${pageContext.servletContext.contextPath}/views/template/admin/dist/css/adminlte.min.css">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <c:forEach items="${videos}" var="video">
                            <tr>
                                ...
                                <td>
                                    <img src="${video.poster}" class="img-fluid" width="150px" height="150px">
                                </td>
                                <td>
                                    <a href="admin/video?action=edit&href=${video.href}" type="button" class="btn btn-success btn-sm btn-block">Edit</a>
                                    <button class="btn btn-danger btn-sm btn-block"
                                            onclick="deleteVideo('${video.href}')">Delete
                                    </button>
                                </td>
                            </tr>
                        </c:forEach>
...
<script>
    function deleteVideo(href) {
        $.ajax({
            url: '/ecommerce_Video_war/admin/video?action=delete&href=' + href
        }).then(function (data) {
